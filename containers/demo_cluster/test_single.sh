...
# LAUNCHER_EXEC_PATH="/tmp2/r14922032/cfc_tensorflow/containers/demo_cluster/bazel-bin/demo_cluster"
...
# KMS_BUNDLE_PATH="/tmp2/r14922032/cfc_tensorflow/bazel-bin/containers/kms/oci_runtime_bundle.tar"
KMS_BUNDLE_PATH="$ARTIFACTS_DIR/kms_oci_runtime_bundle.tar"
# ROOT_PROGRAM_TENSORFLOW_CONTAINER_BUNDLE="/tmp2/r14922032/cfc_tensorflow/program_tensorflow_containers/bazel-bin/oci_runtime_bundle.tar"
...
sudo RUST_LOG=debug GLOG_v=3 "$LAUNCHER_EXEC_PATH" \
    ...
    --test-type="model-loading" \
    --model-file="/tmp2/r14922032/cfc_tensorflow/program_tensorflow_containers/testdata/model1.zip"
